...
var
  replacerFlags, templateFlags, targetFlags: IInterface;
  ...
  commentOutCopyVS: string; //コメントアウト用変数
  trimedTargetFormID, trimedReplacerFormID, slTargetID, slReplacerID, wnamID, slSkinID: string; // SkyPatcher iniファイルの記入用
  useTraits: boolean;
begin
  targetFormID    := '';
  targetEditorID  := '';
  ...
  slExport.Add(commentOutCopyVS + 'match=' + slTargetID + ' swap=' + slReplacerID);
